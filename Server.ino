...
const char* ssid = "Mation265";
const char* password = "mation";
String st;
String content;
...
void createWebServer(int webtype)
{
  ...
  if ( webtype == 1 ) {
    ...
    server.on("/", [](){
      content = "";
      if(getRelay()) {
        content += "<h1>Mation Room</h1><p><a href=\"off\"><button>OFF</button></a></p>";
      } else {
        content += "<h1>Mation Room</h1><p><a href=\"on\"><button>ON</button></a></p>";
      }
      server.send(200, "text/html", content);
    });
